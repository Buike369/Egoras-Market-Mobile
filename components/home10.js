...
const Apple = ()=>{
    ...
    return(
        ...
        <View>
                          ...
                          <View style={{backgroundColor:'white',padding:3,borderBottomLeftRadius:3,borderBottomRightRadius:3,marginTop:3,marginBottom:10}}>
                              <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:10}}>
                                <View style={{alignItems:'center'}}>
                                    <View style={{width:90,backgroundColor:'#f6fff9',alignItems:'center',marginBottom:5}}>
                          ...
                          <View style={{backgroundColor:'#f6fff9',padding:3,borderBottomLeftRadius:3,borderBottomRightRadius:3,marginTop:3,marginBottom:10}}>
                          <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:10}}>
                                <View style={{alignItems:'center'}}>
                        ...
                        <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>HOUSEHOLD CLEANING</Text>
                             <Text style={styles.container5}>SEE ALL</Text>
                          </View> 
                        ...
                        <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>BABY PRODUCTS</Text>
                             <Text style={styles.container5}>SEE ALL</Text>
                          </View> 
