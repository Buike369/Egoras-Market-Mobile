...
const Section =()=>{
    ...
    return(
       ...
       {/* <View style={styles.container114}>
        ...
        {/* <View style={styles.container4}>
          <Pressable onPress={firm}><View testID="make" style={changeFlow === "make"? [styles.container111,styles.container8]:styles.container8}><Text style={changeFlow === 'make'? [styles.container5,styles.container9]:styles.container5}>FOLLOWING</Text></View></Pressable>
           <Pressable onPress={firm1}><View testID="make1"  style={changeFlow === "make1"? [styles.container111,styles.container8]:styles.container8}><Text style={ changeFlow === 'make1'?[styles.container5,styles.container6,styles.container9]:[styles.container5,styles.container6]}>EXPLORE</Text></View></Pressable>
