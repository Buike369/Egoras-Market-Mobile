...
const HeaderImg = [{id:3,img:require('../assets/wed1.jpg')},{id:4,img:require('../assets/wed2.jpg')},{id:5,img:require('../assets/wed3.jpg')}]

const HeaderImg1 = [{id:3,img:require('../assets/wed7.jpg')},{id:4,img:require('../assets/wed9.jpg')},{id:5,img:require('../assets/wed.jpg')},{id:6,img:require('../assets/wed5.jpg')},{id:7,img:require('../assets/wed6.jpg')},{id:8,img:require('../assets/wed5.jpg')},{id:9,img:require('../assets/wed.jpg')}]
...
const Phones =({navigation})=>{
    ...
    // },[])
       ...
       const [count6,setCount2] = useState(true);
       const [count8,setCount3] = useState(false);
         ...
         <View style={styles.container}>
              <View style={{flexDirection:'row',alignItems:'center'}}>
                <Pressable onPress={()=>navigation.goBack()} ><Ionicons name="arrow-back-sharp" size={22} color="#fff" style={{marginLeft:5}}/></Pressable>
                 <Text style={{marginLeft:14,fontSize:16,fontWeight:'700',letterSpacing:0.1,color:'#fff'}}>Footwears</Text>
              </View>
             <View style={{flexDirection:'row',alignItems:'center'}}>
               <Pressable onPress={()=>navigation.navigate('search')}><Ionicons name="md-search" size={18} color="#fff" /></Pressable>
                ...
                <View style={{width:14,height:14,backgroundColor:'#fff',borderRadius:100,position:'absolute',top:-4,right:-3,alignItems:'center',justifyContent:'center'}}><Text style={{fontSize:8,color:'#000'}}>{count4}</Text></View>
              </View>
         </View>
         {/*second Swection*/}
         ...
         <ScrollView showsVerticalScrollIndicator={false}>
           ...
           <View style={{backgroundColor:'#fff',marginTop:8}}>
               <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10,paddingVertical:8,marginBottom:5}}>
                   <Text style={{fontSize:14,fontWeight:'400',}}>Best Deals on Sneakers</Text>
  ...
  {/*another section*/}
           <View style={{backgroundColor:"#fff",paddingTop:10,paddingBottom:15,alignItems:'center',marginTop:8}}>
               <Text style={{color:'#000',fontSize:16,fontWeight:'400'}}>Ladies slippers</Text>
           </View>
           <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',backgroundColor:'#fff',paddingHorizontal:3,paddingBottom:15}}>
             <View style={{width:"23%",alignItems:'center'}}>
                <Image source={require('../assets/slip.jpg')} style={{width:'100%',height:120,borderRadius:3,marginBottom:8}} resizeMode="cover" />
                <Text style={{fontSize:10,color:'#000',}}>Andriod Phones</Text>
             </View>
             <View style={{width:'23%',alignItems:'center'}}>
                <Image source={require('../assets/slip1.jpg')} style={{width:'100%',height:120,borderRadius:3,marginBottom:8}} resizeMode="cover" />
                <Text style={{fontSize:10,color:'#000',}}>Andriod Phones</Text>
             </View>
             <View style={{width:'23%',alignItems:'center'}}>
                <Image source={require('../assets/slip2.jpg')} style={{width:'100%',height:120,borderRadius:3,marginBottom:8}} resizeMode="cover" />
                <Text style={{fontSize:10,color:'#000',}}>Andriod Phones</Text>
             </View>
             <View style={{width:'23%',alignItems:'center'}}>
                <Image source={require('../assets/slip3.jpg')} style={{width:'100%',height:120,borderRadius:3,marginBottom:8}} resizeMode="cover" />
                <Text style={{fontSize:10,color:'#000',}}>Andriod Phones</Text>
             </View>
           </View>
           ...
           <View style={{backgroundColor:'#fff',marginTop:8}}>
               <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:10,paddingVertical:8,marginBottom:5}}>
                   <Text style={{fontSize:14,fontWeight:'400'}}>Sneakers</Text>
                   <Text style={{color:'red',fontSize:12,fontWeight:'400'}}>SEE ALL</Text>
               </View>
               <ScrollView horizontal showsHorizontalScrollIndicator={false}>
               {
