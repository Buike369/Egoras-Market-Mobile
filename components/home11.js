    ...
    return(
        ...
        <View>
                          ...
                          <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>MAKEUP</Text>
                          ...
                          <View style={{backgroundColor:'#f6fff9',padding:3,borderBottomLeftRadius:3,borderBottomRightRadius:3,marginTop:3,marginBottom:10}}>
                              ...
                              <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:10}}>
                                ...
                                <View style={{alignItems:'center'}}>
                                    <View style={{width:90,backgroundColor:'white',alignItems:'center',marginBottom:5}}>
                                      <Image source={require('../assets/dream3.jpg')} resizeMode="contain" style={{width:50,height:50}}/>
                                    </View>
                                    <Text style={{fontSize:8,fontWeight:'300',color:'#000'}}>Noodles</Text>
                                </View>
                              </View>
                          ...
                          <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>FRAGRANCES</Text>
                             <Text style={styles.container5}>SEE ALL</Text>
                          </View>  
                        ...
                        <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>PERSONAL CARE</Text>
                             <Text style={styles.container5}>SEE ALL</Text>
                          </View> 
                        ...
                        <View style={[styles.container6,styles.container8]}>
                             <Text style={styles.container4}>HAIR CARE</Text>
                             <Text style={styles.container5}>SEE ALL</Text>
                          </View> 
