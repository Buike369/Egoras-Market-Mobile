  ...
  <View>
        ...
        {/* <View style={styles.container4}>
          <Pressable onPress={firm}><View testID="make" style={changeFlow === "make"? [styles.container111,styles.container112]:styles.container112}><Text style={changeFlow === 'make'? [styles.container5,styles.container113]:styles.container5}>FOLLOWING</Text></View></Pressable>
           <Pressable onPress={firm1}><View testID="make1"  style={changeFlow === "make1"? [styles.container111,styles.container8]:styles.container112}><Text style={ changeFlow === 'make1'?[styles.container5,styles.container6,styles.container113]:[styles.container5,styles.container6]}>EXPLORE</Text></View></Pressable>
          <Pressable onPress={firm2}><View testID="make2"  style={changeFlow === "make2"? [styles.container111,styles.container112]: styles.container112}><Text style={ changeFlow === "make2" ? [styles.container5,styles.container6,styles.container113]:[styles.container5,styles.container6]}>BLACK FRIDAY</Text></View></Pressable>
        </View> */}
        ...
        <View style={styles.container7}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo7.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10 ,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo10.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10 ,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo11.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo12.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10 ,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo13.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10 ,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <View style={styles.container8}>
                <Text style={{fontSize:10,letterSpacing:0.8,fontWeight:'500',marginBottom:8}}>Fashionable hot sale</Text>
                <Image source={require('../assets/logo14.jpg')}  resizeMode='cover' style={{width:'100%',height:150,marginBottom:10 ,borderRadius:5}}/>
                <Text style={{fontSize:10,letterSpacing:0.5,fontWeight:'300',marginBottom:20}}>Fashionwholesale hot sale</Text>
                <View style={styles.container9}>
                    <Text style={{fontSize:9,letterSpacing:0.5,color:'grey'}}>116 minutes ago</Text>
                    <View style={{flexDirection:'row',alignItems:'center'}}>
